...
### Cursor & Codex（skills only，無 subagent）

vul 沒有專屬 subagent，只需安裝 skills：

```bash
npx skills add poirotw66/velnex-skills --skill vul-analyze --skill vul-decision \
  --skill vul-fix --skill vul-pr --skill vul-cleanup -a cursor -a codex -g -y
